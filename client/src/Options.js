        ...
        <div className="card-body">
          ...
          <div className="btn-group btn-group-toggle" data-toggle="buttons">
            ...
            <label className={this.button2}>
              <input type="radio" id="kilometers" name="distance" autcomplete="off"
                     onChange={this.changeOption}/> Kilometers
            </label>
          </div>
          <div></div>
          <div className="btn-group btn-group-toggle" data-toggle="buttons">
            <label className={this.button3}>
              <input type="radio" id="none" name="optimization" autcomplete="off" onChange={this.changeOption2}/> None
            </label>
